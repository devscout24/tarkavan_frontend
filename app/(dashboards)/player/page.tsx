...
export default function PlayerDashboardPage() {
  ...
  const userInfo = localStorage.getItem("go_elite_user")
    ...
    <SkeletonBoundary loading={loading}>
      <section className=" ">
        ...
        <div className="mt-6 flex w-full flex-col-reverse gap-6 text-white lg:flex-row">
          {/* recent activity */}
          <div className="w-full rounded-[24px] lg:w-[60%]">
                ...
                {dashData?.recent_opportunities?.map((opportunity) => (
                  ...
                  >
                    <Advertisement
                      ...
                      tryoutDate={moment(opportunity.tryout_date).format(
                        "MMM Do YY"
                      )}
          ...
          <div className="w-full lg:w-[40%]">
            ...
            {dashData &&
              dashData?.upcoming_program_reminders &&
              dashData?.upcoming_program_reminders.length > 0 &&
