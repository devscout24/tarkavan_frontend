...
const DownloadIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    <path d="M5.83203 8.33331L9.9987 12.5L14.1654 8.33331" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
)

export default function Export({ onExport, className }: ExportProps) {
  return (
    <Button
      variant="outline"
      size="sm"
