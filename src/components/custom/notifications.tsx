...
const viewAllTextVariants = {
  ...
  return (
    <DropdownMenu>
  <DropdownMenuTrigger>
    <Button className='min-w-10 min-h-10 bg-transparent text-white border-2 border-secondary rounded-[12px]    '> 
        <BellRing />
    </Button>
  </DropdownMenuTrigger>

  <DropdownMenuContent className='border-secondary! border-2  '>
     <motion.div
