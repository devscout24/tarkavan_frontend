  ...
  const handleShare = useCallback(
    async (platform: Platform) => {
      ...
      if (platform.copyFirst) {
        ...
        window.open(
          platform.buildShareUrl(resolvedUrl),
          "_blank",
          "noopener,noreferrer"
        )
        return
      ...
      >
        ...
        <div className="space-y-5 px-5 py-5">
            ...
            <button
              ...
              className={cn(
                ...
                copied
                  ...
                  : "border border-zinc-200 bg-white text-zinc-700 shadow-sm hover:bg-zinc-100 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-600"
              )}
            >
              {copied ? (
                <>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] font-medium tracking-widest text-zinc-400 uppercase dark:text-zinc-500">
              Share to
            </span>
            <div className="h-px flex-1 bg-zinc-100 dark:bg-zinc-800" />
          </div>
                ...
                >
                  <div
                    className={cn(
                      ...
                      "group-disabled:pointer-events-none group-disabled:opacity-40",
                      "group-focus-visible:ring-2 group-focus-visible:ring-zinc-400 group-focus-visible:ring-offset-2",
                      p.iconBg,
                      isActive &&
                        "scale-105 ring-2 ring-emerald-400 ring-offset-2"
                    )}
                  >
                    {isActive ? (
                  ...
                  <span
                    className={cn(
                      "text-center text-[10.5px] leading-tight font-medium",
                      "text-zinc-500 dark:text-zinc-400",
                      "transition-colors group-hover:text-zinc-700 dark:group-hover:text-zinc-300",
        ...
        {toast && (
          <div
            className={cn(
              ...
              "rounded-full px-4 py-2 whitespace-nowrap shadow-lg",
              "text-xs font-medium",
