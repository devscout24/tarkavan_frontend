...
export default function PlayerDashboardLayout({
  ...
  const DATA = {
    ...
    navMain: [
      {
        title: "Dashboard",
        url: `/child-dashboard/${child_id}`,
        icon: RiDashboardFill,
        isActive: true,
      },
      {
        title: "Child Profile",
        url: `/child-dashboard/${child_id}/profile`,
        icon: FaRegUser,
      },
      {
        title: "Programs",
        url: `/child-dashboard/${child_id}/programs`,
        icon: RiMenuSearchLine,
      },
      {
        title: "Search & Explore",
        url: `/child-dashboard/${child_id}/search-explore`,
        icon: RiMenuSearchLine,
      },
    ],
  }
      ...
      <AuthCheckPoint role="parent">
        ...
        <SidebarProvider className="h-screen overflow-hidden">
          ...
          <SidebarInset className="flex h-screen min-h-0 flex-col">
            ...
            {pathname.includes(`/child-dashboard/${child_id}/messages`) ? (
              children
            ) : (
