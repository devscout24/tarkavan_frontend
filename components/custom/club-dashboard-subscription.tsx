...
const ClubDashboardSubscription = () => {
  ...
  return (
    <div
      ...
      className="relative h-96 w- cursor-pointer overflow-hidden rounded-xl bg-secondary p-0.5 text-gray-800 shadow-lg backdrop-blur-md"
    >
      {visible && (
        <div
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center rounded-[10px] bg-secondary  p-6 text-center">
        <Image
          ...
          width={200}
          height={200}
          className="my-4 h-24 w-24 object-contain rounded-full shadow-md"
        />
        <h2 className="mb-1 text-2xl font-bold text-gray-800">
          Go Elite
        </h2>
        <p className="mb-4 text-sm font-medium text-indigo-500">
          Software Developer
        </p>
