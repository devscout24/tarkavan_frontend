...
import OutfieldStatsTab from "@/pages/parent-pages/modals/tabs/outfield-stats-tab"
import GoalkeeperStatsTab from "@/pages/parent-pages/modals/tabs/goalkeeper-stats-tab"

type Role = "outfield" | "goalkeeper"
...
export default function SeasonStats() {
  ...
  const registerStat = (name: keyof SeasonStatsFormData) =>
    register(name, {
  ...
  const getFieldError = (name: StatKey) =>
  ...
  const handleRoleChange = (value: string) => {
    const nextRole: Role = value === "goalkeeper" ? "goalkeeper" : "outfield"
    setRole(nextRole)

    const nextParams = new URLSearchParams(searchParams)
    nextParams.set("seasonStatsRole", nextRole)
  ...
  return (
    <div className="w-full rounded-2xl bg-[#090B10] p-4 text-white sm:p-6 md:p-8">
      ...
      <StepActions onBack={goBackToPositionMap} onNext={goToNextStep} />
    </div>
  )
}
